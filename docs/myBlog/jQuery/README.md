...
$(selector, this)相当于$(this selector)匹配this下的元素，注意this指向
```
...
```js
$('div').each(function(index,context){
  this=>dom对象=>context
  return true => 相当于continue跳过当前循环
  return false=> 相当于break中断循环
})
```
